...
/// Bindings to the namespaced libjped 12-bit
class Jpeg12Native {
  ...
  late final _jpeg12_CreateCompressPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(j12_compress_ptr, ffi.Int32,
              ffi.Int32)>>('jpeg12_CreateCompress');
  ...
  late final _jpeg12_CreateDecompressPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(j12_decompress_ptr, ffi.Int32,
              ffi.Int32)>>('jpeg12_CreateDecompress');
  ...
  late final _jpeg12_stdio_destPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              j12_compress_ptr, ffi.Pointer<ffi.Int32>)>>('jpeg12_stdio_dest');
  late final _jpeg12_stdio_dest = _jpeg12_stdio_destPtr
      .asFunction<void Function(j12_compress_ptr, ffi.Pointer<ffi.Int32>)>();

  void jpeg12_stdio_src(
    j12_decompress_ptr cinfo,
    ffi.Pointer<ffi.Int32> infile,
  ) {
  ...
  late final _jpeg12_stdio_srcPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              j12_decompress_ptr, ffi.Pointer<ffi.Int32>)>>('jpeg12_stdio_src');
  late final _jpeg12_stdio_src = _jpeg12_stdio_srcPtr
      .asFunction<void Function(j12_decompress_ptr, ffi.Pointer<ffi.Int32>)>();

  void jpeg12_mem_dest(
    j12_compress_ptr cinfo,
    ffi.Pointer<ffi.Pointer<ffi.Uint8>> outbuffer,
    ffi.Pointer<ffi.Uint64> outsize,
  ) {
  ...
  late final _jpeg12_mem_destPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ...
              ffi.Pointer<ffi.Uint64>)>>('jpeg12_mem_dest');
  late final _jpeg12_mem_dest = _jpeg12_mem_destPtr.asFunction<
      void Function(j12_compress_ptr, ffi.Pointer<ffi.Pointer<ffi.Uint8>>,
  ...
  late final _jpeg12_mem_srcPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(j12_decompress_ptr, ffi.Pointer<ffi.Uint8>,
              ffi.Uint64)>>('jpeg12_mem_src');
  late final _jpeg12_mem_src = _jpeg12_mem_srcPtr.asFunction<
      void Function(j12_decompress_ptr, ffi.Pointer<ffi.Uint8>, int)>();
  ...
  late final _jpeg12_set_qualityPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              j12_compress_ptr, ffi.Int32, ffi.Int32)>>('jpeg12_set_quality');
  ...
  void jpeg12_add_quant_table(
    j12_compress_ptr cinfo,
    int which_tbl,
    ffi.Pointer<ffi.Uint32> basic_table,
    int scale_factor,
    int force_baseline,
  ) {
  ...
  late final _jpeg12_add_quant_table = _jpeg12_add_quant_tablePtr.asFunction<
      void Function(
          j12_compress_ptr, int, ffi.Pointer<ffi.Uint32>, int, int)>();
  ...
  late final _jpeg12_write_markerPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(j12_compress_ptr, ffi.Int32, ffi.Pointer<JOCTET>,
              ffi.Uint32)>>('jpeg12_write_marker');
  ...
  late final _jpeg12_write_m_headerPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(j12_compress_ptr, ffi.Int32,
              ffi.Uint32)>>('jpeg12_write_m_header');
  ...
  late final _jpeg12_write_m_bytePtr = _lookup<
          ffi.NativeFunction<ffi.Void Function(j12_compress_ptr, ffi.Int32)>>(
      'jpeg12_write_m_byte');
  ...
  late final _jpeg12_read_headerPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              j12_decompress_ptr, ffi.Int32)>>('jpeg12_read_header');
  ...
  late final _jpeg12_j12_start_outputPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              j12_decompress_ptr, ffi.Int32)>>('jpeg12_j12_start_output');
  ...
  late final _jpeg12_save_markersPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(j12_decompress_ptr, ffi.Int32,
              ffi.Uint32)>>('jpeg12_save_markers');
  ...
  late final _jpeg12_j12_resync_to_restartPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              j12_decompress_ptr, ffi.Int32)>>('jpeg12_j12_resync_to_restart');
...
class jpeg12_scan_info extends ffi.Struct {
  ...
  @ffi.Array.multi([4])
  external ffi.Array<ffi.Int32> component_index;
...
class jpeg12_error_mgr extends ffi.Struct {
  ...
  external ffi.Pointer<
          ffi.NativeFunction<ffi.Void Function(j12_common_ptr, ffi.Int32)>>
      j12_emit_message;
  ...
  external ffi.Pointer<
          ffi.NativeFunction<
              ffi.Void Function(j12_common_ptr, ffi.Pointer<ffi.Int8>)>>
      j12_format_message;
  ...
  external ffi.Pointer<ffi.Pointer<ffi.Int8>> jpeg12_message_table;

  @ffi.Int32()
  external int last_jpeg12_message;

  external ffi.Pointer<ffi.Pointer<ffi.Int8>> addon_message_table;
...
class UnnamedUnion1 extends ffi.Union {
  @ffi.Array.multi([8])
  external ffi.Array<ffi.Int32> i;
...
class jpeg12_memory_mgr extends ffi.Struct {
  external ffi.Pointer<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Void> Function(
              j12_common_ptr, ffi.Int32, ffi.Int32)>> j12_alloc_small;

  external ffi.Pointer<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Void> Function(
              j12_common_ptr, ffi.Int32, ffi.Int32)>> j12_alloc_large;

  external ffi.Pointer<
          ffi.NativeFunction<
              JSAMPARRAY Function(
                  j12_common_ptr, ffi.Int32, JDIMENSION, JDIMENSION)>>
      j12_alloc_sarray;
  ...
  external ffi.Pointer<
      ffi.NativeFunction<
          jvirt_sarray_ptr Function(j12_common_ptr, ffi.Int32, ffi.Int32,
              JDIMENSION, JDIMENSION, JDIMENSION)>> j12_request_virt_sarray;

  external ffi.Pointer<
      ffi.NativeFunction<
          jvirt_barray_ptr Function(j12_common_ptr, ffi.Int32, ffi.Int32,
...
class jpeg12_compress_struct extends ffi.Struct {
  ...
  @ffi.Array.multi([4])
  external ffi.Array<ffi.Int32> q_scale_factor;
  ...
  @ffi.Array.multi([10])
  external ffi.Array<ffi.Int32> MCU_membership;
  ...
  external ffi.Pointer<ffi.Int32> natural_order;
...
class jpeg12_decompress_struct extends ffi.Struct {
  ...
  external ffi.Pointer<ffi.Pointer<ffi.Int32>> coef_bits;
...
class jpeg12_source_mgr extends ffi.Struct {
  ...
  external ffi.Pointer<
          ffi.NativeFunction<ffi.Void Function(j12_decompress_ptr, ffi.Int64)>>
      j12_skip_input_data;

  external ffi.Pointer<
          ffi.NativeFunction<ffi.Int32 Function(j12_decompress_ptr, ffi.Int32)>>
